...
var chessAssessDesc = [
    "After having ideas for some chess-related projects in my head for a while, I finally created my chess website, ChessAssess.com, in 2022. It started with a simple opening trainer designed to make moves representative of what you are likely to face in a real game.",
	"After that, I created page to host my chess prediction models during the 2022 Candidates Tournament, which allowed people to follow the tournament live, move-by-move, and watch each player\'s chances of winning update in real time. Players could even input possible game results to see how it would affect the players\' tournament victory chances. To date, I have hosted similar coverage for several tournaments, including the 2023 World Cup, 2023 World Championship, and the 2024 Candidates."
]

var footballDesc = "A program that simulates NFL games based on past team and player stats. It takes into account injuries, snap percentages, target shares, and more to simulate games and predict results."
...
var worldCupDesc = "In 2023 I created this interactive bracket for the 2023 FIDE World Cup Open and Women's section. By hovering over each player's name, you could see their chances of advancing to each round. By clicking on a player to \"pick\" them to win that match, you can see their odds for each round update in real time.";
...
var candidatesDesc = "In April of 2024 I hosted live coverage of the 2024 FIDE Candidates Tournament on ChessAssess. I included a live-updating graph of each player's chances of winning the tournament, with individual graphs for each game. The newest addition this time around was the Most Critical Moves chart, which tracked how every blunder affected the player's tournament chances. After the tournament, I created this video showing the tournament graph from start to finish, along with all of the game boards. The video received some great feedback from the chess community on reddit, and even caught the attention of GM Hikaru Nakamura, who watched and enjoyed the video on his livestream."
...
function ChessPortfolio() {
    ...
    return (
        <div className='Portfolio'>
            ...
            <div className='desc-stuff element-stuff'>
                ...
                <div className='element-desc'>
                    ...
                    <p className='desc-pg'>
                        ...
                        I have a passion for <b><i>Game Development</i></b>, love football, and am a huge <b><i>Chess Fan</i></b>.
                        I run a chess website with the goal of making top-level chess more fun to follow by mixing in some awesome statistics and interactive data visualizations.
                        Feel free to reach out to me via email, Twitter, or LinkedIn!
                    </p><p className='desc-pg'>
                        Below are some chess and sports related projects that I am proud of.
                    </p>
                </div>
            </div>
            ...
            vid={"vRFL3VB94YY"}
            title={"FIDE Candidates 2024"}
            subtitle={"React | Node.js | Python | Unity | C#"}
            desc={[candidatesDesc]}
            links={[
                {
